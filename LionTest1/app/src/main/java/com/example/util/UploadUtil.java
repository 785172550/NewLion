...
public class UploadUtil {
     ...
     * android 上传多张图片到服务器
     */
    public void uploadMultiFile(String[] filePath, String[] fileKey, String requestUrl, Map<String, String> param) {
 ...
 */
            if (param != null && param.size() > 0) {
                ...
                while (it.hasNext()) {
                    ...
                    stringBuffer.append(value).append(LINE_END);
...
// dos.flush();
            ...
            for (int i = 0; i < filePath.length; i++) {
                 ...
                 */
                sb.append("Content-Disposition: form-data; name=\"" + i + "\"; filename=\"" + file.getName() + "\"" + LINE_END);
                ...
                is.close();
                dos.write(LINE_END.getBytes());//一个文件结束标志
            }

            byte[] end_data = (PREFIX + BOUNDARY + PREFIX + LINE_END).getBytes();//结束 http 流
            dos.write(end_data);
            dos.flush();
